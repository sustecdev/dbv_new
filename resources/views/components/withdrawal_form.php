...
<div class="bg-black border border-gray-800 rounded-xl p-6 shadow-lg">
    ...
    <form id="withdraw-form" class="mt-5 space-y-4">
        ...
        <div>
            ...
            <input id="wdl-amount" type="number" step="0.01" min="0.01" max="5000000" class="w-full bg-black border border-gray-800 rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-gray-700 focus:ring-1 focus:ring-gray-700" placeholder="e.g. 10.00" />
